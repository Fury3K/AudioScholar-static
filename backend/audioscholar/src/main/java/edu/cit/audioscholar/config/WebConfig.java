	...
	public void addCorsMappings(CorsRegistry registry) {
		registry.addMapping("/**")
				.allowedOrigins("http://localhost:8100", "https://localhost:8100", "capacitor://localhost",
						...
						"http://localhost:5174", "https://localhost:5174", "http://localhost:8080", "https://localhost:8080",
						"https://it342-g3-audioscholar.onrender.com", "https://it342-g3-audioscholar-onrender-com.onrender.com",
